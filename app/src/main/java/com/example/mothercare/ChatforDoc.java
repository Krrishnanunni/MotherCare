...
public class ChatforDoc extends Activity  implements JsonResponse
{
    EditText ed1;
    ImageView b1,b2;
    String chat;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_chatfor_doc);
        ...
        t1.setText(ViewDoctor.doctorname);
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View arg0)
            {
                ...
                else
                {
                    ...
                    JR.json_response=(JsonResponse) ChatforDoc.this;
                    String q = "/chatfordoc?chat=" + chat + "&loginid=" + Login.lid + "&id=" + ViewDoctor.did;
                    q=q.replace(" ","%20");
                    JR.execute(q);
    ...
    void getChats() {
        ...
        JsonReq JR=new JsonReq();
        JR.json_response=(JsonResponse) ChatforDoc.this;
        String q = "/viewchatfordoc?logid=" +Login.lid + "&id=" + ViewDoctor.did;
        q=q.replace(" ","%20");
...
//					 val=new String[ja1.length()];
            ...
            if(method.equalsIgnoreCase("done")){
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    startActivity(new Intent(getApplicationContext(),ChatforDoc.class));
