...
//        Toast.makeText(this, "Payment successful: " + razorpayPaymentId, Toast.LENGTH_LONG).show();
        ...
        String q = "/userMakeAppointment?did=" + ViewConsultingTIme.doctor_id + "&cid=" + ViewConsultingTIme.conid + "&lid=" + Login.lid + "&amt=" + ViewConsultingTIme.amt;
        q=q.replace( " ", "%20");
        JR.execute(q);
